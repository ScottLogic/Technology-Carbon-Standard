...
import techCarbonStandardV001Schema from "../techcarbonstandard_schema/v0.0.1.json";
import techCarbonStandardV001Example from "../examples/techcarbonstandard_schema/v0.0.1.json";
...
beforeEach(() => {
  validate = ajv.compile<any>(techCarbonStandardV001Schema);
  testDocument = structuredClone(techCarbonStandardV001Example);
});

describe('Tech Carbon Standard v0.0.1 documents', () => {
