...
title: Tech Carbon Standard Schema v0.1.0
permalink: /schemas/tech-carbon-standard/v0-1-0
---

# Tech Carbon Standard Schema v0.1.0
...
**Schema Information**:
- **Schema ID**: [`https://techcarbonstandard.org/schemas/tech_carbon_standard/v0.1.0.json`](/schemas/tech_carbon_standard/v0.1.0.json)
- **Version**: `0.1.0`
...
**v0.1.0 (current):**
- Added `content` category to upstream emissions that encompasses foundation models, as well as content and data treated as commodities by organisations
- Renamed `end_user_devices` to `customer_devices` in downstream emissions to better represent the category and avoid confusion.

**v0.0.2:**
- [Tech Carbon Standard v0.0.2](/schemas/tech-carbon-standard/v0-0-2)
...
```json
{
  ...
  "upstream_emissions": {
    ...
    "foundation_models": { "emissions": 0, "notes": "..." },
    "content_and_data": { "emissions": 0, "notes": "..." }
  },
  "direct_emissions": {
  ...
  "downstream_emissions": {
    "customer_devices": { "emissions": 1000, "notes": "..." },
...
| foundation_models | Embodied carbon in training and inference of foundation models | |
| content_and_data | Embodied carbon in content and data used as a commodity | |
...
- Schema version must be exactly `"0.1.0"`
...
| Wrong schema version | Incorrect version string | Use exactly `"0.1.0"` |
...
- [Schema File](https://techcarbonstandard.org/schemas/tech_carbon_standard/v0.1.0.json)
