...
Where cloud services are used to store and serve content and data, organisations must account for the emissions generated by the scale of their operations, taking into account data redundancy (where the same data is stored in multiple locations to prevent data loss), metadata management and the increase use of AI and Machine Learning to optimise video compression, enable auto-caption and translation, and improve content recommendations.
