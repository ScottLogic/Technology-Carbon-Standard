...
This challenge becomes even more pressing with the rise of AI-powered applications. For example, organisations increasingly interact with large language models (LLMs) directly through their chatbot platforms (e.g., Claude, Le Chat, ChatGPT), API providers (e.g., Anthropic, OpenAI, Google), and AI-driven tools (e.g., Copilot, AI-enhanced search engines). As companies embed these AI-driven SaaS solutions into their workflows, the share of emissions attributable to their usage must be identified and included in organisational carbon accounting.

{% include linkedHeading.html heading="Managed Services" level=3 %}

Managed services are functions of your business that you outsource to Managed Service Providers (MSPs) - third-party companies that specialise in managing services for other businesses. This might be a company that handles your IT support, backup services or security. But could also be HR, payroll or marketing.

It can be a challenge to obtain detailed energy usage or lifecycle data from these third-party providers, further complicated by the multi-tenant nature of the platform making it difficult to allocate emissions fairly across clients.

It is therefore important when selecting your MSP to choose one that is transparent around emissions and aligns with your sustainability goals. Look for providers that publish sustainability reports and support standards such as the GHG Protocol.


{% include linkedHeading.html heading="Offsite Employee Devices" level=3 %}

This category includes emissions generated by personal computers (desktops, laptops), monitors, printers, and other devices used by employees outside the office. These devices may be either company-issued or privately owned (as in Bring Your Own Device, or BYOD) but are used for work purposes. However, as with other indirect sources, the business does not have direct control over them. Therefore, they come under [GHG Protocol Scope 3](/resources/glossary#greenhouse-gas-ghg-protocols), and so are a separate category.

It is easy to overlook the emissions from this category as they are not being generated directly by the company. However, with the rise of remote and hybrid working along with the increase in computing power needed by employees to work with AI, it's becoming increasingly important to account for emissions from offsite employee devices. Even when employees use thier own devices for work, the associated emissions should still be reported on as they support business operations.
