...
This category includes greenhouse gas emissions generated by computers (desktops, laptops), monitors, printers, and other devices used by employees outside the office. These devices may be either company-issued or personal (as in Bring Your Own Device, or BYOD) but are used for work purposes. However, as with other indirect sources, the business does not have direct control over them. Therefore, they come under [GHG Protocol Scope 3](/resources/glossary#greenhouse-gas-ghg-protocols), and so are a separate category.

It is easy to overlook the emissions from this category as they are not being generated directly by the company. However, with the rise of remote and hybrid working along with the increase in computing power needed by employees to work with AI, it's becoming increasingly important to account for emissions from offsite employee devices. Even when employees use personal devices for work, the associated emissions should still be reported on as they support business operations.
